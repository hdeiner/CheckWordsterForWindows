...
namespace CheckWordsterForWindows.SpecFlowTests.Features
{
    ...
    public partial class CheckWordsterCoreFeature : Xunit.IClassFixture<CheckWordsterCoreFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "CheckWordsterCoreServerCode.feature"
#line hidden
        
        public CheckWordsterCoreFeature(CheckWordsterCoreFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "CheckWordsterCore", @"  For the hipster bank customer
...
#line 10
  #line 11
    testRunner.Given("I start the \"no\" server", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
        }
        ...
        [Xunit.TraitAttribute("FeatureTitle", "CheckWordsterCore")]
...
#line hidden
        ...
        [Xunit.TheoryAttribute(DisplayName="Convert numbers into words when there are errors")]
        [Xunit.TraitAttribute("FeatureTitle", "CheckWordsterCore")]
        [Xunit.TraitAttribute("Description", "Convert numbers into words when there are errors")]
        [Xunit.InlineDataAttribute("", "CheckWordster - Null number", new string[0])]
        [Xunit.InlineDataAttribute("8x20", "CheckWordster - Invalid characters", new string[0])]
        [Xunit.InlineDataAttribute("10,0000", "CheckWordster - Invalid format", new string[0])]
        [Xunit.InlineDataAttribute("10000.000", "CheckWordster - Invalid format", new string[0])]
        [Xunit.InlineDataAttribute("10.00.27", "CheckWordster - Invalid format", new string[0])]
        [Xunit.InlineDataAttribute("+2.+00", "CheckWordster - Invalid signed number", new string[0])]
        [Xunit.InlineDataAttribute("-20", "CheckWordster - Signed number", new string[0])]
        [Xunit.InlineDataAttribute("+2.25", "CheckWordster - Signed number", new string[0])]
        [Xunit.InlineDataAttribute("1000000000000000", "CheckWordster - Too many digits", new string[0])]
        public virtual void ConvertNumbersIntoWordsWhenThereAreErrors(string number, string exception, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Convert numbers into words when there are errors", exampleTags);
#line 85
  this.ScenarioSetup(scenarioInfo);
#line 10
  this.FeatureBackground();
#line 86
    testRunner.Given("I start the \"no\" server", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 87
    testRunner.When(string.Format("I convert \"{0}\" into words, an exception \"{1}\" should be thrown", number, exception), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            this.ScenarioCleanup();
        }
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                CheckWordsterCoreFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                CheckWordsterCoreFeature.FeatureTearDown();
            }
        }
    }
}
